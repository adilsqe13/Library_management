    ...
    <div class="row p-0">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 bg-library-img m-0">
            ...
            <div class="row bg-dark opact-90" style="padding: 14px ;">
                <div class="col-3"></div>
                <div class="col-6">
                    <h1 class="text-center text-white">Open Records</h1>
                </div>
                <div class="col-3 dfjeac">
                    <button  type="button" class="btn btn-lg bg-green-light  text-white bold" data-bs-toggle="modal" data-bs-target="#borrowBookModal">
                        Borrow book
                    </button>
                </div>
            </div>
            ...
            <?php include 'open_records_display.php'; ?>
            <?php include 'modal/borrow_book_modal.php'; ?>
