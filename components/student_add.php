    ...
    <div class="row p-0">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 bg-library-img m-0">
            <div class="row bg-dark opact-90" style="padding: 14px ;">
                <div class="col-3"></div>
                <div class="col-6">
                    <h1 class="text-center text-white">Student List</h1>
                </div>
                <div class="col-3 dfjeac">
                    <button type="button" class="btn btn-lg btn-warning text-dark bold" data-bs-toggle="modal" data-bs-target="#addCandidateModal">
                        Add Student
                    </button>
                </div>
            </div>
            ...
            <!-- Add book form modal -->
            <?php include 'modal/add_student_modal.php'; ?>
